...
namespace Parser.Exceptions
{
    public class MarkupParserException : Exception
    {
        ...
        protected MarkupParserException(string message, List<string> parsedLines, int relativeLine, int blockStartLine) : base(message)
        {
            if (relativeLine != -1 && blockStartLine != -1)
            {
