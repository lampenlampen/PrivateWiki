...
using PrivateWiki.Annotations;

namespace PrivateWiki
{
	public class AppSettings
	{
		public MarkdownRenderingSettings MarkdownRenderingSettings = new MarkdownRenderingSettings();
	}

	public class MarkdownRenderingSettings : INotifyPropertyChanged
	{
